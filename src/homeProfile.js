                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm">
                      ...
                      <p>Perfect date?</p>
                      <p>Doing something active, like a hike :)</p>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm">
                      ...
                      <p>
                        <em>Perfect date?</em> Going to a local indie concert
                        and grabbing drinks after!
                      </p>
                      <a href="#" class="btn btn-info">
                        Like
                      </a>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm">
                      ...
                      <p>
                        Dates make me nervous so anything as chilled out as
                        possible.
                      </p>
                      <a href="#" class="btn btn-info">
                        Like
